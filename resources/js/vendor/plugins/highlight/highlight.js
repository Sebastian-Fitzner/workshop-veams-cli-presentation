...
hljs.LANGUAGES.fsharp = function(a) {
	...
	return {
		...
		}, a.CLCM, a.CBLCLM, a.inherit(a.ASM, {
			i: null
		}), a.inherit(a.QSM, {
			i: null
		}), a.CNM]
...
hljs.LANGUAGES.lasso = function(b) {
	...
	return {
		...
		c: [{
			...
			cN: "preprocessor",
			b: "\\[no_square_brackets|\\[/noprocess|" + c
		}, {
			cN: "preprocessor",
			b: "\\[",
			r: 0
			...
			b: "/\\*\\*!",
			e: "\\*/"
		}, b.CBLCLM, b.CNM, b.inherit(b.ASM, {
			i: null
		}), b.inherit(b.QSM, {
			i: null
		}), {
...
hljs.LANGUAGES.scss = function(a) {
	...
	return {
		...
		c: [a.CLCM, a.CBLCLM, {
			...
			b: "@",
			e: "[{;]",
			k: "mixin include for extend charset import media page font-face namespace",
